...
@section('content')
    <section class="w-[25%] mx-auto backdrop-blur-xl bg-slate-950/30 rounded-xl border-2 border-indigo-600">
        @if (session('message'))
        ...
        <div class="flex w-full flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <div class="mt-10 sm:mx-auto space-y-6 w-full sm:max-w-sm">
                <form class="space-y-6" action="/articles/{{ $article->id }}" method="POST">
                    ...
                    <div class="flex flex-col gap-3">
                        <button type="submit"
                            class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-xl font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Update
                            Article</button>
                        <a href="/articles"
                            class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-xl font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                            Cancel Update
                        </a>
                    </div>
                </form>
